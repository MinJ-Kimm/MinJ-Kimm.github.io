---
layout: single
title:  "Comparative analysis of KBO batters through baseball data analysis"
categories: data
tag: [python, data Analysis]
---
# 야구 데이터 분석을 통한 KBO 타자 비교분석/ <br> Comparative analysis of KBO batters through baseball data analysis
